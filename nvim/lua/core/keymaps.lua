...
keymap.set('n', '<leader>1', '<CMD>tabn1<CR>')
keymap.set('n', '<leader>2', '<CMD>tabn2<CR>')
keymap.set('n', '<leader>3', '<CMD>tabn3<CR>')
keymap.set('n', '<leader>4', '<CMD>tabn4<CR>')
keymap.set('n', '<leader>5', '<CMD>tabn5<CR>')
keymap.set('n', '<leader>6', '<CMD>tabn6<CR>')
keymap.set('n', '<leader>7', '<CMD>tabn7<CR>')
keymap.set('n', '<leader>8', '<CMD>tabn8<CR>')
keymap.set('n', '<leader>9', '<CMD>tabn9<CR>')
keymap.set('v', '<leader>1', '<CMD>tabn1<CR>')
keymap.set('v', '<leader>2', '<CMD>tabn2<CR>')
keymap.set('v', '<leader>3', '<CMD>tabn3<CR>')
keymap.set('v', '<leader>4', '<CMD>tabn4<CR>')
keymap.set('v', '<leader>5', '<CMD>tabn5<CR>')
keymap.set('v', '<leader>6', '<CMD>tabn6<CR>')
keymap.set('v', '<leader>7', '<CMD>tabn7<CR>')
keymap.set('v', '<leader>8', '<CMD>tabn8<CR>')
keymap.set('v', '<leader>9', '<CMD>tabn9<CR>')
